...
3. `m68k-linux-gnu-as` to assemble
...
- [ ] Does PCC `ccom` compile our preprocessed hello.i without crashing? (CI run 7+ answer)
- [ ] Does Retro68's `crt0.o` have any GCC-specific relocations that `m68k-linux-gnu-ld` can't handle?
